...
//=============================================================================
// MZ-Quiz-Engine.js
// getQuestionJS, numbers, function name?, pluginNameJS
//=============================================================================
/*:
 * @target MZ
 ...
 *
 * @command getQuestionJS
 * @desc This pulls the next question from questionDatabaseJS.js
 *
 * @help Please see MZ Quizzer documentation for more help. 
 *
 * Game VARIABLES and SWITCHES begin at 1001 and are reserved up to 1009 
 * for this plugin. 
 *
 * Game Switch 1001 - Switch that activates upon correct answer response
 *
 * Game Switch 1002 - Switch that activates upon wrong answer response
 *
 * Game Variable 1001 - stores text input strings 
 * for answering Short Answer questions. 
 * 
 * Game Variable 1002 - the current question number and determines which 
 * question to pull next from the database. 
 *
 * Game Variable 1003 - total number of correct answers. 
 *
 * Game Variable 1004 - total number of wrong answers. 
 *
 * Game Variable 1005 - Question Timer Result. 
 *
 * Game Variable 1006 - Streak Count (correct answers in a row). 
 *
 * Game Variable 1007 - Slump Count (wrong answers in a row). 
 *
 * Game Variable 1008 - Reward ID. 
 *
 * Game Variable 1009 - Reward Amount.
 *
 * Game Variable 1000 - Incorrect Answer Explanation Text 
 *
 * PICTURES 106, 107, 108, and 109 are used. DO NOT USE THESE PICTURE NUMBERS.
 * 
 * CREDITS
...
const pluginNameJS = "MZQuizzerJS";

function getQuestionJS(e) {
    var t = questionDatabaseJS.Questions[e].T;
    questionDatabaseJS.Questions[e].Q_T;
    1 < t && setChoiceTimer(t);
    var s, a;
    questionDatabaseJS.Questions[e].I;
    switch (1 == questionDatabaseJS.Questions[e].E ? (s = questionDatabaseJS.Questions[e].Q, console.log(s), s = rotHex(s), s = atob(s)) : (s = questionDatabaseJS.Questions[e].Q, console.log(s)), questionDatabaseJS.Questions[e].Q_T) {
        case 1:
            a = 200 < s.length ? stringDividerJS(s = "\\}" + s, 105, "\n") : stringDividerJS(s, 56, "\n"), window.formattedQuestion = a, askShortAnswerQuestionJS(e, a);
            break;
        case 2:
            a = 200 < s.length ? stringDividerJS(s = "\\}" + s, 105, "\n") : stringDividerJS(s, 56, "\n"), askMultipleChoiceQuestion2JS(e, a);
            break;
        case 3:
            a = 200 < s.length ? stringDividerJS(s = "\\}" + s, 105, "\n") : stringDividerJS(s, 56, "\n"), askMultipleChoiceQuestion3JS(e, a);
            break;
        case 4:
            a = 200 < s.length ? stringDividerJS(s = "\\}" + s, 105, "\n") : stringDividerJS(s, 56, "\n"), askMultipleChoiceQuestion4JS(e, a);
            break;
        case 5:
            a = 200 < s.length ? stringDividerJS(s = "\\}" + s, 105, "\n") : stringDividerJS(s, 56, "\n"), askMultipleChoiceQuestion5JS(e, a);
            break;
        case 9:
            a = 200 < s.length ? stringDividerJS(s = "\\}" + s, 105, "\n") : stringDividerJS(s, 56, "\n"), askTrueOrFalseQuestionJS(e, a);
            break;
        default:
...
function calculateAverageJS(e, t) {
    let s = e / (t + 1) * 100;
    return s = +s.toFixed(2), s
}

function stringDividerJS(e, t, s) {
    if (e.length > t) {
        for (var a = t; 0 < a && " " != e[a]; a--);
        if (0 < a) return e.substring(0, a) + s + stringDividerJS(e.substring(a + 1), t, s)
    }
    return e
}
...
PluginManager.registerCommand(pluginNameJS, "getQuestionJS", e => {
    $gameScreen.erasePicture(109), $gameScreen.erasePicture(108), $gameScreen.erasePicture(107), $gameScreen.erasePicture(106), $gameScreen.erasePicture(105), $gameSwitches.setValue(1001, !1), $gameSwitches.setValue(1002, !1), $gameVariables.setValue(1e3, 0);
    var t = $gameVariables.value(1002),
        s = questionDatabaseJS.Questions.length;
    console.log(s), s <= t && (t = 0, $gameVariables.setValue(1002, 0), window.questionNumber = t), console.log("Question number " + t), getQuestionJS(window.questionNumber = t)
}), askMultipleChoiceQuestion2JS = function(e, t) {
    var s = questionDatabaseJS.Questions[e].E,
        a = questionDatabaseJS.Questions[e].C_A,
        i = questionDatabaseJS.Questions[e].A2;   
    1 == s && (a = rotHex(a), a = atob(a), i = rotHex(i), i = atob(i)), a = 200 < a.length ? stringDividerJS(a = "\\}" + a, 105, "\n") : stringDividerJS(a, 56, "\n"), i = 200 < i.length ? stringDividerJS(i = "\\}" + i, 105, "\n") : stringDividerJS(i, 56, "\n");
    var n = questionDatabaseJS.Questions[e].I;
    1 == n && ($gameScreen.showPicture(107, "MZQ_picBG", 0, 4, 174, 100, 100, 255, 0), $gameScreen.showPicture(108, questionDatabaseJS.Questions[e].GUID, 0, 14, 192, 100, 100, 255, 0));
    var r = questionDatabaseJS.Questions[e].A;
    $gameMessage.setPositionType(0), $gameMessage.add(t), 1 == (r = questionDatabaseJS.Questions[e].A) && ($gameScreen.showPicture(109, "MZQ_audio", 0, 0, 574, 100, 100, 255, 0), t = questionDatabaseJS.Questions[e].GUID, PlayAudio1(t));
...
}, askMultipleChoiceQuestion3JS = function(e, t) {
    var s = questionDatabaseJS.Questions[e].E,
        a = questionDatabaseJS.Questions[e].C_A,
        i = questionDatabaseJS.Questions[e].A2,
        n = questionDatabaseJS.Questions[e].A3;
    1 == s && (a = rotHex(a), a = atob(a), i = rotHex(i), i = atob(i), n = rotHex(n), n = atob(n)), a = 200 < a.length ? stringDividerJS(a = "\\}" + a, 105, "\n") : stringDividerJS(a, 56, "\n"), i = 200 < i.length ? stringDividerJS(i = "\\}" + i, 105, "\n") : stringDividerJS(i, 56, "\n"), n = 200 < n.length ? stringDividerJS(n = "\\}" + n, 105, "\n") : stringDividerJS(n, 56, "\n");
    var r = questionDatabaseJS.Questions[e].I;
    1 == r && ($gameScreen.showPicture(107, "MZQ_picBG", 0, 4, 174, 100, 100, 255, 0), $gameScreen.showPicture(108, questionDatabaseJS.Questions[e].GUID, 0, 14, 192, 100, 100, 255, 0)), $gameMessage.setPositionType(0), $gameMessage.add(t);
    var o = questionDatabaseJS.Questions[e].A;
    1 == o && ($gameScreen.showPicture(109, "MZQ_audio", 0, 0, 574, 100, 100, 255, 0), t = questionDatabaseJS.Questions[e].GUID, PlayAudio1(t));
...
}, askMultipleChoiceQuestion4JS = function(e, t) {
    var s = questionDatabaseJS.Questions[e].E,
        a = questionDatabaseJS.Questions[e].C_A,
        i = questionDatabaseJS.Questions[e].A2,
        n = questionDatabaseJS.Questions[e].A3,
        r = questionDatabaseJS.Questions[e].A4;
    1 == s && (a = rotHex(a), a = atob(a), i = rotHex(i), i = atob(i), n = rotHex(n), n = atob(n), r = rotHex(r), r = atob(r)), a = 200 < a.length ? stringDividerJS(a = "\\}" + a, 105, "\n") : stringDividerJS(a, 56, "\n"), i = 200 < i.length ? stringDividerJS(i = "\\}" + i, 105, "\n") : stringDividerJS(i, 56, "\n"), n = 200 < n.length ? stringDividerJS(n = "\\}" + n, 105, "\n") : stringDividerJS(n, 56, "\n"), r = 200 < r.length ? stringDividerJS(r = "\\}" + r, 105, "\n") : stringDividerJS(r, 56, "\n");
    var o = questionDatabaseJS.Questions[e].I;
    1 == o && ($gameScreen.showPicture(107, "MZQ_picBG", 0, 4, 174, 100, 100, 255, 0), $gameScreen.showPicture(108, questionDatabaseJS.Questions[e].GUID, 0, 14, 192, 100, 100, 255, 0)), $gameMessage.setPositionType(0), $gameMessage.add(t);
    var d = questionDatabaseJS.Questions[e].A;
    1 == d && ($gameScreen.showPicture(109, "MZQ_audio", 0, 0, 574, 100, 100, 255, 0), t = questionDatabaseJS.Questions[e].GUID, PlayAudio1(t));
...
}, askMultipleChoiceQuestion5JS = function(e, t) {
    var s = questionDatabaseJS.Questions[e].E,
        a = questionDatabaseJS.Questions[e].C_A,
        i = questionDatabaseJS.Questions[e].A2,
        n = questionDatabaseJS.Questions[e].A3,
        r = questionDatabaseJS.Questions[e].A4,
        o = questionDatabaseJS.Questions[e].A5;
    1 == s && (a = rotHex(a), a = atob(a), i = rotHex(i), i = atob(i), n = rotHex(n), n = atob(n), r = rotHex(r), r = atob(r), o = rotHex(o), o = atob(o)), a = 200 < a.length ? stringDividerJS(a = "\\}" + a, 105, "\n") : stringDividerJS(a, 56, "\n"), i = 200 < i.length ? stringDividerJS(i = "\\}" + i, 105, "\n") : stringDividerJS(i, 56, "\n"), n = 200 < n.length ? stringDividerJS(n = "\\}" + n, 105, "\n") : stringDividerJS(n, 56, "\n"), r = 200 < r.length ? stringDividerJS(r = "\\}" + r, 105, "\n") : stringDividerJS(r, 56, "\n"), o = 200 < o.length ? stringDividerJS(o = "\\}" + o, 105, "\n") : stringDividerJS(o, 56, "\n");
    var d = questionDatabaseJS.Questions[e].I;
    1 == d && ($gameScreen.showPicture(107, "MZQ_picBG", 0, 4, 174, 100, 100, 255, 0), $gameScreen.showPicture(108, questionDatabaseJS.Questions[e].GUID, 0, 14, 192, 100, 100, 255, 0));
    var u = questionDatabaseJS.Questions[e].A;
    $gameMessage.setPositionType(0), $gameMessage.add(t), 1 == u && ($gameScreen.showPicture(109, "MZQ_audio", 0, 0, 574, 100, 100, 255, 0), t = questionDatabaseJS.Questions[e].GUID, PlayAudio1(t));
    ...
    var s = questionDatabaseJS.Questions[g].E,
        h = questionDatabaseJS.Questions[g].Q_T,
        m = questionDatabaseJS.Questions[g].GUID,
        p = questionDatabaseJS.Questions[g].Q,
        l = questionDatabaseJS.Questions[g].C_A,
        _ = questionDatabaseJS.Questions[g].A2,
        $ = questionDatabaseJS.Questions[g].A3 || "",
        P = questionDatabaseJS.Questions[g].A4 || "",
        M = questionDatabaseJS.Questions[g].A5 || "",
        b = questionDatabaseJS.Questions[g].S || "";
    1 == s && (p = rotHex(p), p = atob(p), l = rotHex(l), l = atob(l), _ = rotHex(_), _ = atob(_), $ = rotHex($), $ = atob($), P = rotHex(P), P = atob(P), M = rotHex(M), M = atob(M)), $gameMessage.setChoiceCallback(function(e) {
        ...
        switch ($gameVariables.setValue(1005, s), $gameScreen.erasePicture(107), $gameScreen.erasePicture(108), $gameScreen.erasePicture(109), d = e - c[e]) {
            case 0:
                var a = '{"GUID":' + m + ',"Q_N":' + g + ',"I_C":"Y","T":' + s + ',"Q_T":' + h + '"Q":"' + p + '","C_A":"' + l + '","A2":"' + _ + '","A3":"' + $ + '","A4":"' + P + '","A5":"' + M + '","S":"' + b + '"},';
                console.log(a);
                var i = $gameVariables.value(1003) + 1;
                $gameVariables.setValue(1003, i), calculateAverageJS(i, g), rewardSystem();
                break;
            case 1:
                a = '{"GUID":' + m + ',"Q_N":' + g + ',"I_C":"N","G_A":"' + _ + '","T":' + s + ',"Q_T":4,"Q":"' + p + '","C_A":"' + l + '","A2":"' + _ + '","A3":"' + $ + '","A4":"' + P + '","A5":"' + M + '","S":"' + b + '"},';
                console.log(a);
                var n = $gameVariables.value(1004) + 1;
                $gameVariables.setValue(1004, n);
                var r = i / g * 100,
                    r = Math.floor(r),
                    o = questionDatabaseJS.Questions[g].A2_Why || 0;
                penaltySystem(o);
                break;
            case 2:
                a = '{"GUID":' + m + ',"Q_N":' + g + ',"I_C":"N","G_A":"' + $ + '","T":' + s + ',"Q_T":' + h + ',"Q":"' + p + '","C_A":"' + l + '","A2":"' + _ + '","A3":"' + $ + '","A4":"' + P + '","A5":"' + M + '","S":"' + b + '"},';
                console.log(a);
                n = $gameVariables.value(1004) + 1;
                $gameVariables.setValue(1004, n);
                r = i / g * 100, r = Math.floor(r), o = questionDatabaseJS.Questions[g].A3_Why || 0;
                penaltySystem(o);
                break;
            case 3:
                ...
                n = $gameVariables.value(1004) + 1;
                $gameVariables.setValue(1004, n);
                r = i / g * 100, r = Math.floor(r), o = questionDatabaseJS.Questions[g].A4_Why || 0;
                penaltySystem(o);
                break;
            case 4:
                ...
                n = $gameVariables.value(1004) + 1;
                $gameVariables.setValue(1004, n);
                r = i / g * 100, r = Math.floor(r), o = questionDatabaseJS.Questions[g].A5_Why || 0;  
                penaltySystem(o);
                break;
            default:
...
}, askTrueOrFalseQuestionJS = function(e, t) {
    questionDatabaseJS.Questions[e].Q, questionDatabaseJS.Questions[e].C_A;
    var s = questionDatabaseJS.Questions[e].I,
        a = questionDatabaseJS.Questions[e].A;
    1 == s && ($gameScreen.showPicture(107, "MZQ_picBG", 0, 4, 174, 100, 100, 255, 0), $gameScreen.showPicture(108, questionDatabaseJS.Questions[e].GUID, 0, 14, 192, 100, 100, 255, 0)), 1 == a && ($gameScreen.showPicture(109, "MZQ_audio", 0, 0, 574, 100, 100, 255, 0), PlayAudio1(questionDatabaseJS.Questions[e].GUID)), $gameMessage.setPositionType(0), $gameMessage.add(t);
    t = (new Date).getTime();
    ...
    $gameMessage.setChoiceCallback(function(e) {
        var t = questionDatabaseJS.Questions[g].E,
            s = questionDatabaseJS.Questions[g].GUID,
            a = (questionDatabaseJS.Questions[g].Q_T, questionDatabaseJS.Questions[g].Q),
            i = (questionDatabaseJS.Questions[g].I, questionDatabaseJS.Questions[g].A, questionDatabaseJS.Questions[g].C_A),
            n = questionDatabaseJS.Questions[g].S || "",
            r = questionDatabaseJS.Questions[g].A2_Why || 0;
        ...
        $gameVariables.setValue(1005, t), $gameScreen.erasePicture(107), $gameScreen.erasePicture(108), $gameScreen.erasePicture(109), e == i ? (d = '{"GUID":' + s + ',"Q_N":' + g + ',"I_C":"Y","T":' + t + ',"Q_T":2,"Q":"' + a + '","C_A":"' + (i = 0 == i ? "TRUE" : "FALSE") + '","S":"' + n + '"},', console.log(d), o = $gameVariables.value(1003) + 1, $gameVariables.setValue(1003, o), u = o / g * 100, u = Math.floor(u), rewardSystem()) : (u = (u = (d = (d = 0 == i ? '{"GUID":' + s + ',"Q_N":' + g + ',"I_C":"N","G_A":"FALSE","T":' + t + ',"Q_T":2,"Q":"' + a + '","C_A": "TRUE", "S":"' + n + '"},' : '{"GUID":' + s + ',"Q_N":' + g + ',"I_C":"N","G_A":"TRUE","T":' + t + ',"Q_T":2,"Q":"' + a + '","C_A":"FALSE","S":"' + n + '"},', console.log(d), $gameVariables.value(1004) + 1), $gameVariables.setValue(1004, d), o / g * 100), Math.floor(u)), penaltySystem(r))
    })
}, askShortAnswerQuestionJS = function(e) {
    ...
    this.createSpriteset(), this._varID = 1001;
    var r = questionDatabaseJS.Questions[questionNumber].C_A;
    ...
    var e;
    Scene_MenuBase.prototype.start.call(this), 1 == questionDatabaseJS.Questions[questionNumber].I && (e = questionDatabaseJS.Questions[questionNumber].GUID, this._myPic = new Sprite(ImageManager.loadPicture(e)), this.addChild(this._myPic), this._myPic.x = 460, this._myPic.y = 205), this._editWindow.refresh()
    ...
    $gameVariables.setValue(1001, this._editWindow.text()), this.popScene(), checkAnswer_SA(questionNumber)
    ...
    var s = questionDatabaseJS.Questions[e].GUID,  
        a = (questionDatabaseJS.Questions[e].Q_T, questionDatabaseJS.Questions[e].Q),
        i = (questionDatabaseJS.Questions[e].I, questionDatabaseJS.Questions[e].A, questionDatabaseJS.Questions[e].C_A),
        n = questionDatabaseJS.Questions[e].C_S,
        r = questionDatabaseJS.Questions[e].S || "";
    1 == questionDatabaseJS.Questions[e].E && (i = rotHex(i), i = atob(i));
    var o = $gameVariables.value(1001);
    ...
    $gameVariables.setValue(1005, t), o == i ? (u = '{"GUID":' + s + ',"Q_N":' + e + ',"I_C":"Y","T":' + t + ',"Q_T":1,"Q":"' + a + '","C_A":"' + i + '","S":"' + r + '"},', console.log(u), d = $gameVariables.value(1003) + 1, $gameVariables.setValue(1003, d), calculateAverageJS(d, e), rewardSystem()) : (u = '{"GUID":' + s + ',"Q_N":' + e + ',"I_C":"N","G_A":"' + o + '","T":' + t + ',"Q_T":1,"Q":"' + a + '","C_A":"' + i + '","S":"' + r + '"},', console.log(u), u = $gameVariables.value(1004) + 1, $gameVariables.setValue(1004, u), o = o + " is not the correct answer.", calculateAverageJS(d, e), penaltySystem(o))
}, showCorrectAnswerPicture = function() {
    $gameScreen.showPicture(106, "MZQ_correctAnswer", 0, 330, 230, 100, 100, 255, 0), setTimeout(function() {
        $gameScreen.erasePicture(106), $gameSystem.onBeforeSave(), DataManager.saveGame(1)
    }, 800)
}, rewardSystem = function() {
    console.log(questionNumber), $gameTimer.stop(), playSoundEffect("MZQ_correctAnswer");
    var e = questionDatabaseJS.Questions[questionNumber].A,
        t = questionDatabaseJS.Questions[questionNumber].GUID;
    1 == e && AudioManager.stopSeAt(t), showCorrectAnswerPicture();
    e = $gameVariables.value(1006) + 1;
    $gameVariables.setValue(1006, e), $gameVariables.setValue(1007, 0);
    var t = questionDatabaseJS.Questions[questionNumber].R_T,
        s = questionDatabaseJS.Questions[questionNumber].R_I,
        a = questionDatabaseJS.Questions[questionNumber].R_A,
        e = questionDatabaseJS.Questions[questionNumber].O_L; 
    "Enemy" == t && (BattleManager.setup(s, !0, !0), $gamePlayer.makeEncounterCount(), SceneManager.push(Scene_Battle)), "Gold" == t && ($gameParty.gainGold(a), $gameVariables.setValue(1009, a), $gameMessage.add("REWARD: \\{\\c[14]Gain \\G"), $gameMessage.add("\\{+\\v[1009]\\c[14]\\G")), "Armor" == t && ($gameParty.gainItem($dataArmors[s], a, !0), $gameVariables.setValue(1008, $dataArmors[s].name), $gameVariables.setValue(1009, a), $gameMessage.add("REWARD: \\{\\c[4]Gain Armor"), $gameMessage.add("\\{+\\c[6]\\v[1008] \\c[0]\\{x\\c[6]\\v[1009]")), "Item" == t && ($gameParty.gainItem($dataItems[s], a), $gameVariables.setValue(1008, $dataItems[s].name), $gameVariables.setValue(1009, a), $gameMessage.add("REWARD: \\{\\c[4]Gain Item"), $gameMessage.add("\\{+\\c[6]\\v[1008] \\c[0]\\{x\\c[6]\\v[1009]")), "Weapon" == t && ($gameParty.gainItem($dataWeapons[s], a, !0), $gameVariables.setValue(1008, $dataWeapons[s].name), $gameVariables.setValue(1009, a), $gameMessage.add("REWARD: \\{\\c[4]Gain Weapon"), $gameMessage.add("\\{+\\c[6]\\v[1008] \\c[0]\\{x\\c[6]\\v[1009]")), "HP" == t && (1 == e ? ($gameParty.leader().gainHp(a), $gameVariables.setValue(1009, a), $gameMessage.add("REWARD: \\{\\c[4]Party Leader Gains HP")) : ($gameParty.members().forEach(function(e) {
        e.gainHp(a)
    }), $gameVariables.setValue(1009, a), $gameMessage.add("REWARD: \\{\\c[4]Entire Party Gains HP")), $gameMessage.add("\\{+\\v[1009] \\c[6]HP")), "XP" == t && (1 == e ? ($gameParty.leader().gainExp(a), $gameVariables.setValue(1009, a), $gameMessage.add("REWARD: \\{\\c[4]Party Leader Gains XP")) : ($gameParty.members().forEach(function(e) {
        e.gainExp(a)
    }), $gameVariables.setValue(1009, a), $gameMessage.add("REWARD: \\{\\c[4]Entire Party Gains XP")), $gameMessage.add("\\{+\\v[1009] \\c[6]XP")), "MP" == t && (1 == e ? ($gameParty.leader().gainHp(a), $gameVariables.setValue(1009, a), $gameMessage.add("REWARD: \\{\\c[4]Party Leader Gains MP"), $gameMessage.add("\\{+\\v[1009] \\c[6]MP")) : ($gameParty.members().forEach(function(e) {
        e.gainMp(a)
    }), $gameVariables.setValue(1009, a), $gameMessage.add("REWARD: \\{\\c[4]Entire Party Gains XP"), $gameMessage.add("\\{+\\v[1009] \\c[6]XP"))), "TP" == t && (1 == e ? ($gameParty.leader().gainTp(a), $gameVariables.setValue(1009, a), $gameMessage.add("REWARD: \\{\\c[4]Party Leader Gains TP")) : ($gameParty.members().forEach(function(e) {
        e.gainTp(a)
    }), $gameVariables.setValue(1009, a), $gameMessage.add("REWARD: \\{\\c[4]Entire Party Gains TP")), $gameMessage.add("\\{+\\v[1009] \\c[6]TP")), "Skill" == t && (1 == e ? ($gameParty.leader().learnSkill(s), $gameVariables.setValue(1008, $dataSkills[s].name), $gameMessage.add("REWARD: \\{\\c[4]Party Leader Learns Skill")) : ($gameParty.members().forEach(function(e) {
        e.learnSkill(s)
    }), $gameVariables.setValue(1008, $dataSkills[s].name), $gameMessage.add("REWARD: \\{\\c[4]Entire Party Learns Skill")), $gameMessage.add("\\{+\\c[6]\\v[1008]")), "MHP" == t && (1 == e ? ($gameParty.leader().addParam(0, a), $gameVariables.setValue(1009, a), $gameMessage.add("REWARD: \\{\\c[4]Party Leader Increases Max HP")) : ($gameParty.members().forEach(function(e) {
        e.addParam(0, a)
    }), $gameVariables.setValue(1009, a), $gameMessage.add("REWARD: \\{\\c[4]Entire Party Increase Max HP")), $gameMessage.add("\\{+\\v[1009] \\c[6]Max HP")), "MMP" == t && (1 == e ? ($gameParty.leader().addParam(1, a), $gameVariables.setValue(1009, a), $gameMessage.add("REWARD: \\{\\c[4]Party Leader Increases Max MP")) : ($gameParty.members().forEach(function(e) {
        e.addParam(1, a)
    }), $gameVariables.setValue(1009, a), $gameMessage.add("REWARD: \\{\\c[4]Entire Party Increases Max MP")), $gameMessage.add("\\{+\\v[1009] \\c[6]Max MP")), "ATK" == t && (1 == e ? ($gameParty.leader().addParam(2, a), $gameVariables.setValue(1009, a), $gameMessage.add("REWARD: \\{\\c[4]Party Leader Increases ATK")) : ($gameParty.members().forEach(function(e) {
        e.addParam(2, a)
    }), $gameVariables.setValue(1009, a), $gameMessage.add("REWARD: \\{\\c[4]Entire Party Increases ATK")), $gameMessage.add("\\{+\\v[1009] \\c[6]ATK")), "DEF" == t && (1 == e ? ($gameParty.leader().addParam(3, a), $gameVariables.setValue(1009, a), $gameMessage.add("REWARD: \\{\\c[4]Party Leader Increases DEF")) : ($gameParty.members().forEach(function(e) {
        e.addParam(3, a)
    }), $gameVariables.setValue(1009, a), $gameMessage.add("REWARD: \\{\\c[4]Entire Party Increases DEF")), $gameMessage.add("\\{+\\v[1009] \\c[6]DEF")), "AddState" == t && (1 == e ? ($gameParty.leader().addState(s), $gameVariables.setValue(1008, $dataStates[s].name), $gameMessage.add("REWARD: \\{\\c[4]Party Leader State Added")) : ($gameParty.members().forEach(function(e) {
        e.addState(s)
    }), $gameVariables.setValue(1008, $dataStates[s].name), $gameMessage.add("REWARD: \\{\\c[4]Entire Party State Added")), $gameMessage.add("\\{+\\c[6]\\v[1008]")), "RemoveState" == t && (1 == e ? ($gameParty.leader().removeState(s), $gameVariables.setValue(1008, $dataStates[s].name), $gameMessage.add("REWARD: \\{\\c[4]Party Leader State Removed")) : ($gameParty.members().forEach(function(e) {
        e.removeState(s)
    }), $gameVariables.setValue(1008, $dataStates[s].name), $gameMessage.add("REWARD: \\{\\c[4]Entire Party State Removed")), $gameMessage.add("\\{-\\c[6]\\v[1008]")), $gameVariables.setValue(1002, questionNumber + 1), console.log("Question number " + $gameVariables.value(1002)), $gameSwitches.setValue(1001, !0)
}, showWrongAnswerPicture = function() {
    $gameScreen.showPicture(106, "MZQ_wrongAnswer", 0, 330, 230, 100, 100, 255, 0), setTimeout(function() {
        $gameScreen.erasePicture(106), $gameSystem.onBeforeSave(), DataManager.saveGame(1)
    }, 800)
}, penaltySystem = function(e) {
    $gameTimer.stop(), playSoundEffect("MZQ_wrongAnswer");
    var t = questionDatabaseJS.Questions[questionNumber].A,
        s = questionDatabaseJS.Questions[questionNumber].E,
        a = questionDatabaseJS.Questions[questionNumber].GUID;
    null != e && 1 == s && (e = rotHex(e), e = atob(e)), null == e && (e = "The question timer expired."), 0 == e && (e = "No explanation for wrong answer provided."), e = 200 < e.length ? stringDividerJS(e = "\\}" + e, 105, "\n") : stringDividerJS(e, 56, "\n"), $gameVariables.setValue(1e3, e), console.log(e), 1 == t && AudioManager.stopSeAt(a), showWrongAnswerPicture();
    t = $gameVariables.value(1007) + 1;
    $gameVariables.setValue(1007, t), $gameVariables.setValue(1006, 0);
    var a = questionDatabaseJS.Questions[questionNumber].P_T,
        i = questionDatabaseJS.Questions[questionNumber].P_I,
        n = questionDatabaseJS.Questions[questionNumber].P_A,
        t = questionDatabaseJS.Questions[questionNumber].O_L;
    "Enemy" == a && (BattleManager.setup(i, !1, !1), $gamePlayer.makeEncounterCount(), SceneManager.push(Scene_Battle)), "Gold" == a && ($gameParty.loseGold(n), $gameVariables.setValue(1009, n), $gameMessage.add("PENALTY: \\{\\c[8]Lose \\G"), $gameMessage.add("\\c[18]\\{-\\v[1009]\\c[8]\\G")), "Armor" == a && ($gameParty.gainItem($dataArmors[i], -n, !0), $gameVariables.setValue(1008, $dataArmors[PenaltyId].name), $gameVariables.setValue(1009, n), $gameMessage.add("PENALTY: \\{\\c[31]Lose Armor"), $gameMessage.add("\\{-\\c[18]\\v[1008] \\c[0]\\{x\\c[8]\\v[1009]")), "Item" == a && ($gameParty.gainItem($dataItems[i], -n), $gameVariables.setValue(1008, $dataItems[i].name), $gameVariables.setValue(1009, n), $gameMessage.add("PENALTY: \\{\\c[31]Lose Item"), $gameMessage.add("\\{-\\c[18]\\v[1008] \\c[0]\\{x\\c[8]\\v[1009]")), "Weapon" == a && ($gameParty.gainItem($dataWeapons[i], -n, !0), $gameVariables.setValue(1008, $dataWeapons[i].name), $gameVariables.setValue(1009, n), $gameMessage.add("PENALTY: \\{\\c[31]Lose Weapon"), $gameMessage.add("\\{-\\c[18]\\v[1008] \\c[0]\\{x\\c[8]\\v[1009]")), "HP" == a && (1 == t ? ($gameParty.leader().gainHp(-n), $gameVariables.setValue(1009, n), $gameMessage.add("PENALTY: \\{\\c[31]Party Leader Loses HP")) : ($gameParty.members().forEach(function(e) {
        e.gainHp(-n)
    }), $gameVariables.setValue(1009, n), $gameMessage.add("PENALTY: \\{\\c[31]Entire Party Loses HP")), $gameMessage.add("\\{-\\c[18]\\v[1009] \\c[8]HP")), "XP" == a && (1 == t ? ($gameParty.leader().gainExp(-n), $gameVariables.setValue(1009, n), $gameMessage.add("PENALTY: \\{\\c[31]Party Leader Loses XP")) : ($gameParty.members().forEach(function(e) {
        e.gainExp(-n)
    }), $gameVariables.setValue(1009, n), $gameMessage.add("PENALTY: \\{\\c[31]Entire Party Loses XP")), $gameMessage.add("\\{-\\c[18]\\v[1009] \\c[8]XP")), "MP" == a && (1 == t ? ($gameParty.leader().gainMp(-n), $gameVariables.setValue(1009, n), $gameMessage.add("PENALTY: \\{\\c[31]Party Leader Loses MP")) : ($gameParty.members().forEach(function(e) {
        e.gainMp(n)
    }), $gameVariables.setValue(1009, n), $gameMessage.add("PENALTY: \\{\\c[31]Entire Party Loses MP")), $gameMessage.add("\\{-\\c[18]\\v[1009] \\c[8]MP")), "TP" == a && (1 == t ? ($gameParty.leader().gainTp(-n), $gameVariables.setValue(1009, n), $gameMessage.add("PENALTY: \\{\\c[31]Party Leader Loses TP")) : ($gameParty.members().forEach(function(e) {
        e.gainTp(-n)
    }), $gameVariables.setValue(1009, n), $gameMessage.add("PENALTY: \\{\\c[31]Entire Party Loses TP")), $gameMessage.add("\\{-\\c[18]\\v[1009] \\c[8]TP")), "Skill" == a && (1 == t ? ($gameParty.leader().forgetSkill(i), $gameVariables.setValue(1008, $dataWeapons[i].name), $gameMessage.add("PENALTY: \\{\\c[31]Party Leader Loses Skill")) : ($gameParty.members().forEach(function(e) {
        e.forgetSkill(i)
    }), $gameVariables.setValue(1008, $dataWeapons[i].name), $gameMessage.add("PENALTY: \\{\\c[31]Entire Party Loses Skill")), $gameMessage.add("\\{-\\c[18]\\v[1008] \\c[0]\\{x\\c[8]\\v[1009]")), "MHP" == a && (1 == t ? ($gameParty.leader().addParam(0, -n), $gameVariables.setValue(1009, n), $gameMessage.add("PENALTY: \\{\\c[31]Party Leader Decreases Max HP")) : ($gameParty.members().forEach(function(e) {
        e.addParam(0, -n)
    }), $gameVariables.setValue(1009, n), $gameMessage.add("PENALTY: \\{\\c[31]Entire Party Decreases Max HP")), $gameMessage.add("\\{-\\c[18]\\v[1009] \\c[8]MHP")), "MMP" == a && (1 == t ? ($gameParty.leader().addParam(1, -n), $gameVariables.setValue(1009, n), $gameMessage.add("PENALTY: \\{\\c[31]Party Leader Decreases Max MP")) : ($gameParty.members().forEach(function(e) {
        e.addParam(1, -n)
    }), $gameVariables.setValue(1009, n), $gameMessage.add("PENALTY: \\{\\c[31]Entire Party Decreases Max MP")), $gameMessage.add("\\{-\\c[18]\\v[1009] \\c[8]MMP")), "ATK" == a && (1 == t ? ($gameParty.leader().addParam(2, -n), $gameVariables.setValue(1009, n), $gameMessage.add("PENALTY: \\{\\c[31]Party Leader Decreases ATK")) : ($gameParty.members().forEach(function(e) {
        e.addParam(2, -n)
    }), $gameVariables.setValue(1009, n), $gameMessage.add("PENALTY: \\{\\c[31]Entire Party Decreases ATK")), $gameMessage.add("\\{-\\c[18]\\v[1009] \\c[8]ATK")), "DEF" == a && (1 == t ? ($gameParty.leader().addParam(3, -a), $gameVariables.setValue(1009, n), $gameMessage.add("PENALTY: \\{\\c[31]Party Leader Decreases DEF")) : ($gameParty.members().forEach(function(e) {
        e.addParam(3, -n)
    }), $gameVariables.setValue(1009, n), $gameMessage.add("PENALTY: \\{\\c[31]Entire Party Decreases DEF")), $gameMessage.add("\\{-\\c[18]\\v[1009] \\c[8]DEF")), "AddState" == a && (1 == t ? ($gameParty.leader().addState(i), $gameVariables.setValue(1008, $dataStates[i].name), $gameMessage.add("PENALTY \\{\\c[31]Party Leader State Added")) : ($gameParty.members().forEach(function(e) {
        e.addState(i)
    }), $gameVariables.setValue(1008, $dataStates[i].name), $gameMessage.add("PENALTY \\{\\c[31]Entire Party State Added")), $gameMessage.add("\\{+\\c[18]\\v[1008]")), "RemoveState" == a && (1 == t ? ($gameParty.leader().removeState(i), $gameVariables.setValue(1008, $dataStates[i].name), $gameMessage.add("PENALTY \\{\\c[31]Party Leader State Removed")) : ($gameParty.members().forEach(function(e) {
        e.removeState(i)
    }), $gameVariables.setValue(1008, $dataStates[i].name), $gameMessage.add("PENALTY \\{\\c[31]Entire Party State Removed")), $gameMessage.add("\\{+\\c[18]\\v[1008]")), $gameVariables.setValue(1002, questionNumber + 1), $gameSwitches.setValue(1002, !0)
    ...
    var t = {
        name: questionDatabaseJS.Questions[questionNumber].GUID,
        volume: 100,
        pitch: 100,
        pan: 0
    };
...
Window_Message.prototype.updateShowFast = function() {
    ...
    $gameScreen.erasePicture(109), $gameScreen.erasePicture(108), $gameScreen.erasePicture(107), $gameScreen.erasePicture(106), $gameScreen.erasePicture(105), 1 == questionDatabaseJS.Questions[questionNumber].Q_T && SceneManager.pop(), console.log("Time has expired"), $gameTimer.stop(), $gameMessage.forceCancel(), penaltySystem()
};